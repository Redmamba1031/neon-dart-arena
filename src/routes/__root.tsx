...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Compete in skill-based GranBoard darts contests in 501 and Cricket — win prizes on performance." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "SMYD — Online GranBoard Darts Esports" },
      { name: "twitter:description", content: "Compete in skill-based GranBoard darts contests in 501 and Cricket — win prizes on performance." },
