...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Wager, compete, and win on real-money GranBoard darts matches in 501." },
      { property: "og:title", content: "SMYD — Online GranBoard Darts Esports" },
      { property: "og:description", content: "Wager, compete, and win on real-money GranBoard darts matches in 501." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "SMYD — Online GranBoard Darts Esports" },
      { name: "twitter:description", content: "Wager, compete, and win on real-money GranBoard darts matches in 501." },
