...
export const Route = createFileRoute("/checkout/return")({
  ...
  head: () => ({ meta: [{ title: "Purchase complete — SMYD" }] }),
    ...
    <AppShell>
      <div className="px-5 py-12 text-center space-y-4 animate-fade-in-up">
        ...
        <div className="flex gap-3 justify-center">
          ...
          <Link
            to="/shop"
            className="inline-block rounded-xl bg-surface ring-1 ring-border px-6 py-3 text-sm font-bold uppercase tracking-wider"
          >
            Back to shop
          </Link>
        </div>
